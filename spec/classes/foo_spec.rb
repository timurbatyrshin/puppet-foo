...
describe 'foo' do
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'foo').send(:parameters)[:helper]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'foo').send(:parameters)[:ensure]
  ...
  describe 'Test params lookup' do
    let(:facts) { { :foo_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
  ...
  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :foo_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
